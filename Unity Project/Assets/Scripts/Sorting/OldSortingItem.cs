...
{
    // FANCY SEEING YOU HERE, WELL IM SORRY TO TELL YOU;
    // BUT THIS SCRIPT IS NO LONGER USED AND IS ONLY HERE
    // SO MY CRAPPY CODE DOESN'T BREAK. IT CAN MOST LIKELY BE
    // REMOVED BUT I'VE PROBABLY FORGOT. HAVE A NICE DAY! :)
